...
(function() {
  ...
  $(document).on('click', '.refritter-note', function(evt) {
      var item = $(this).parent();
      var originalPoster = item.data('creator');
      var fritterText = item.data('frittertext');
      var content = "ReFrittered from " + originalPoster + ": " + fritterText;
